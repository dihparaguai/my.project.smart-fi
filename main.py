...
transaction1 = Transaction(
    user_id=2, category=category1, payment_type=payment_type1, id=1,
    fact_date="2024-12-09", payment_date="2024-12-10", description="Compra de supermercado", transaction_type="expense", value=150.75)
transaction2 = Transaction(
    user_id=1, category=category2, payment_type=payment_type2, id=2, fact_date="2023-11-08",
    payment_date="2022-09-11", description="Compra de lanche", transaction_type="income", value=0.75)
transaction_dict = {
...
def _user_register():
    ...
    # verifica se ususario ja existe
    user = User.query.filter_by(email=email)
    if user:
...
def _user_recover_password():
    ...
    # atualiza a senha do usuario informado
    user = User.query.filter_by(email=email)
